...
- Create Angular project with ng: `ng new invennaopdracht.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`invennaopdracht.client.esproj`).
